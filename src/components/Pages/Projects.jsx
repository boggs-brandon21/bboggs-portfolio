			...
			<RevealOnScroll>
				...
				<div className="w-full-flex">
					...
					>
						...
						through examples of my work. Each project is briefly
						described with links to code repositories in it as well
						as a video walkthrough of my fullstack app code.
					</motion.p>
				</div>
